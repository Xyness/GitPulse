...
import { MapPin, Building2, Link as LinkIcon, Star, BookMarked, Users } from "lucide-react";
    ...
    <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
      ...
      <div className="flex-1 text-center sm:text-left">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-6 sm:justify-start">
          ...
          <Stat icon={<BookMarked className="h-4 w-4" />} label="Repos" value={user.repositories.totalCount} />
        </div>
      </div>
    </div>
  );
